...
When both treatments reached the 8th day, although correlation was lower compared to the two-day growth (r = 0.46) in water treatment, it was still significant (p = 0.02). But the correlation was very low (r = 0.24) and no significant (p = 0.26) in the enriched treatment. Probably due to the plants had absorbed the nutrient so that the change of growth become larger. 